...
> - Weight $1/2$, so it is not itself in any [[def-mk|space of modular forms]] — but its powers are: $\eta^{24} = \Delta$ ([[def-disc-definition]]), the first [[def-cusp-form|cusp form]] of level one.
