...
> - $\Lambda_8$ ([[e8-set]]) is the lattice this development is about, and [[e8-defs-equivalent]] identifies it with the $\mathbb{Z}$-span of [[e8-matrix|eight explicit vectors]].
