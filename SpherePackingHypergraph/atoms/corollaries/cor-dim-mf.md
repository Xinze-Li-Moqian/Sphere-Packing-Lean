...
>
> So $\dim M_2=\lfloor 2/12\rfloor=0$, while for $k=4,6,8,10$ the formula gives $0+1=1$ — each space is spanned by its [[def-ek|Eisenstein series]] — and at $k=12$ it gives $1+1=2$, the new dimension being the first [[def-cusp-form|cusp form]], $\Delta$ ([[def-disc-definition]]).
>
