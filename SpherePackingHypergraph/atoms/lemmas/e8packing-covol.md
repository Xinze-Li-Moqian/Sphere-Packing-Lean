...
> The covolume of a full-rank [[iszlattice|lattice]] is $|\det M|$ for any matrix $M$ whose columns are a $\mathbb{Z}$-basis, and by [[e8-defs-equivalent]] the columns of $\mathcal{B}_8$ ([[e8-matrix]]) are such a basis for $\Lambda_8$.
>
