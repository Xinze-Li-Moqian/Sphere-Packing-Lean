...
>
> In particular the slash is a right action of $\Gamma_1$, which is what lets [[def-mk|modularity]] be checked on the two generators $S$ and $T$ ([[def-gamma-generators]]) alone.
